...
namespace Lakion\SyliusElasticSearchBundle\Tests\DependencyInjection\Compiler;
...
final class RegisterFilterTypePassTest extends AbstractCompilerPassTestCase
{
    ...
    public function it_collects_tagged_filter_types()
    {
        ...
        $this->setDefinition(
            ...
            (new Definition())->addTag('form.type')->addTag('filter.type', ['type' => 'option'])
        );
        ...
        $this->assertContainerBuilderHasServiceDefinitionWithMethodCall(
            ...
            'add',
            ['default', 'option', new Reference('lakion_sylius_elastic_search.form_type.filter')]
        );
    }
